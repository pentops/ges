...
const (
	FooQueryService_FooGet_FullMethodName    = "/gestest.v1.service.FooQueryService/FooGet"
	FooQueryService_FooList_FullMethodName   = "/gestest.v1.service.FooQueryService/FooList"
	FooQueryService_FooEvents_FullMethodName = "/gestest.v1.service.FooQueryService/FooEvents"
)
...
func (c *fooQueryServiceClient) FooGet(ctx context.Context, in *FooGetRequest, opts ...grpc.CallOption) (*FooGetResponse, error) {
	...
	err := c.cc.Invoke(ctx, FooQueryService_FooGet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fooQueryServiceClient) FooList(ctx context.Context, in *FooListRequest, opts ...grpc.CallOption) (*FooListResponse, error) {
	...
	err := c.cc.Invoke(ctx, FooQueryService_FooList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fooQueryServiceClient) FooEvents(ctx context.Context, in *FooEventsRequest, opts ...grpc.CallOption) (*FooEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FooQueryService_FooEvents_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var FooQueryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gestest.v1.service.FooQueryService",
	...
	Metadata: "gestest/v1/service/foo.p.j5s.proto",
}
